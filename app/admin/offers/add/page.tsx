...
export default function AddOfferPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>("all"); // Updated default value to "all"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && json.success) {
        ...
        toast.error(json.message || "Error creating offer");
      }
    } catch {
  ...
  return (
    <div className="w-full p-6 md:p-10">
      ...
      <h1 className="text-3xl font-bold mb-6 text-orange-600">Add New Offer</h1>
